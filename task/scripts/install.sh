#!/usr/bin/env bash
# Install the `task` skill group into the target vault.
#
# Steps:
#   1. Run prepare-vault.sh to ensure the tasks/ layout exists in the vault.
#   2. Copy each skill from task/skills/task-* into:
